const items = [{
    ...
    },
    {
        ...
        description: "Надувной игровой центр без всяких сомнений понравится любому ребенку. ",
        tags: ["3+"],
        price: 280.70,
    ...
    },
    {
        ...
        description: "Этот красочный пазл для детей перенесёт вашего ребёнка в загадочное подземное царство.",
        tags: ["6+"],
        price: 22.39,
    ...
    },
    {
        ...
        description: "Бассейн кит станет отличным развлечением для вашего ребенка в жаркую погоду!",
        tags: ["2+"],
        price: 98,
        img: "./img/1-intex.jpg",
        rating: 4.9,
    ...
    },
    {
        ...
        description: "Конструктор познакомит малыша с увлекательным миром животных, позволяя придумывать различные игровые сценарии.",
        tags: ["3+"],
        price: 163,
        img: "./img/polesie.jpg",
        rating: 4.9,
